    ...
    public class PlayerFire : MonoBehaviour
    {
        ...
        private void FireWeapon(int num)
        {
            if (_impactTransform != null) {
                ...
                FirePortal(num, transform.parent.position, transform.forward, _fireMaxDistance);
            }
        ...
        private void FirePortal(int portalId, Vector3 pos, Vector3 dir, float distance)
        {
            ...
            if (((1 << hit.collider.gameObject.layer) & _surfaceMask) != 0) {
                ...
                if (_shootThroughPortals && inPortal != null && inPortal.LinkedPortal != null) {
                ...
                Enemy.Enemy enemy = hit.collider.GetComponent<Enemy.Enemy>();
                if (enemy != null) {
                    enemy.OnHit();
                }
                SetPortalVariable(hit, portalId);
